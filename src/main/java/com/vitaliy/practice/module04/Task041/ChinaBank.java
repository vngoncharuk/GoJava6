...
public class ChinaBank extends Bank {
    public static final int LIMIT_WITHDRAWAL_USD = 100;
    public static final int LIMIT_WITHDRAWAL_EUR = 150;
    public static final int LIMIT_FUNDING_USD = 10000;
    public static final int LIMIT_FUNDING_EUR = 5000;
    public static final double MONTH_RATE_USD = 0.01;
    public static final double MONTH_RATE_EUR = 0.00;
    public static final double WITHDRAW_COMMISS_USD_LESS_1000 = 0.03;
    public static final double WITHDRAW_COMMISS_USD_MORE_1000 = 0.05;
    public static final double WITHDRAW_COMMISS_EUR_LESS_1000 = 0.1;
    public static final double WITHDRAW_COMMISS_EUR_MORE_1000 = 0.11;
